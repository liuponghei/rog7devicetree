...
BOARD_KERNEL_CMDLINE := video=vfb:640x400,bpp=32,memsize=3072000 qcom_geni_serial.con_enabled=0 firmware_class.path=/vendor/firmware bootconfig
...
BOARD_ASUS_DYNAMIC_PARTITIONS_PARTITION_LIST := \
    odm \
    system \
    product \
    vendor_dlkm \
...
include vendor/asus/ASUS_AI2205/BoardConfigVendor.mk
